...
<div id="wrap">
  ...
  <div id="header">
    ...
    <div id="infobox">
      ...
      <span>This template uses minimum graphics, clean layout and dark red color. Ideal for Business or Personal Websites.</span> </div>
  </div>
  <div id="sidenotes">
    <div class="sidenav">
      <ul>
        <li><a class="active" href="#">Site News</a></li>
  ...
  <div id="contents">
    ...
    <div class="blogbottom"> <a href="#">Readmore</a><a href="#">6 Comments</a>
      <hr />
    </div>
  ...
  <div id="footer">
    ...
    <div class="footerinner">&copy; Information Goes Here | Valid <a href="http://validator.w3.org/check?uri=referer">XHTML 1.1</a> and <a href="#">CSS 2.0</a></div>
  </div>
</div>
<div id="bottompage">
